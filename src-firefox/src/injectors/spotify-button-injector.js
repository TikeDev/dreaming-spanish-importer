...
window.onload = function () {
  ...
  function createTrackListPageBtns(trackListElements){
    ...
    trackListElements.forEach((trackListElement) => {
      ...
      img.src = browser.runtime.getURL("images/dreamingplus.png"); // Reference the image
      ...
      if (markedFinishedEl.length <= 2){
        ...
        if (isMarkedFinished){
          img.src = browser.runtime.getURL("images/dreamingplus-warn.png"); // Reference the image
          img.style.opacity = ".5";
